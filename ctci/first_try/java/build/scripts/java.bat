...
set CLASSPATH=%APP_HOME%\lib\ctci-1.0.0.jar

@rem Execute java
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %JAVA_OPTS%  -classpath "%CLASSPATH%" net.finalatomicbuster.ctci.Main %CMD_LINE_ARGS%
